...
class RunEventProcessorWorkerConsoleCommand extends AbstractInterruptibleConsoleCommand implements WorkerWatcherInterface
{
    use LockableTrait;

    private const PID_FILE_NAME = '/tmp/orkestra_event_processor.pid';

    protected static $defaultName = 'orkestra:messaging:process-events';

    /**
     * @var EventProcessorWorker
     */
    private $worker;
    ...
    public function __construct(EventProcessorWorker $worker)
    {
        parent::__construct();
        $this->worker = $worker;
